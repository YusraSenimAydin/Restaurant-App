...
var Element = (props) => {
  ...
  const sizeStyle = React29.useMemo(() => typeof size === "number" ? {
    width: size,
    height: size,
    lineHeight: `${size}px`
  } : {}, [size]);
...
var style_default = genComponentStyleHook("Skeleton", (token2) => {
  const {
    componentCls
  } = token2;
...
var SkeletonAvatar = (props) => {
  ...
  return wrapSSR(React30.createElement("div", {
    className: cls
  }, React30.createElement(Element_default, Object.assign({
...
var SkeletonButton = (props) => {
  ...
  return wrapSSR(React31.createElement("div", {
    className: cls
...
var SkeletonInput = (props) => {
  ...
  return wrapSSR(React33.createElement("div", {
    className: cls
  }, React33.createElement(Element_default, Object.assign({
...
var SkeletonNode = (props) => {
  ...
  const content = children !== null && children !== void 0 ? children : React34.createElement(DotChartOutlined_default, null);
  return wrapSSR(React34.createElement("div", {
    className: cls
...
var Paragraph = (props) => {
  ...
  return React35.createElement("ul", {
...
var Title = (_ref) => {
  ...
  return React36.createElement("h3", {
...
var Skeleton = (props) => {
  ...
  if (loading || !("loading" in props)) {
    ...
    if (hasAvatar) {
      ...
      avatarNode = React37.createElement("div", {
        className: `${prefixCls}-header`
      }, React37.createElement(Element_default, Object.assign({}, avatarProps)));
    }
    let contentNode;
    if (hasTitle || hasParagraph) {
      let $title;
      if (hasTitle) {
        ...
        $title = React37.createElement(Title_default, Object.assign({}, titleProps));
      }
      let paragraphNode;
      if (hasParagraph) {
        ...
        paragraphNode = React37.createElement(Paragraph_default, Object.assign({}, paragraphProps));
      }
      contentNode = React37.createElement("div", {
    ...
    return wrapSSR(React37.createElement("div", {
      className: cls,
...
var StatisticNumber = (props) => {
  ...
  if (typeof formatter === "function") {
    ...
    if (!cells || val === "-") {
      ...
      valueNode = [React38.createElement("span", {
        key: "int",
        className: `${prefixCls}-content-value-int`
      }, negative, int), decimal && React38.createElement("span", {
        key: "decimal",
        className: `${prefixCls}-content-value-decimal`
      }, decimal)];
    }
  }
  return React38.createElement("span", {
...
var style_default2 = genComponentStyleHook("Statistic", (token2) => {
...
var Statistic = (props) => {
  ...
  const valueNode = React39.createElement(Number_default, Object.assign({
    decimalSeparator,
    groupSeparator,
    prefixCls
  }, props, {
  ...
  const cls = (0, import_classnames11.default)(prefixCls, {
    [`${prefixCls}-rtl`]: direction === "rtl"
  }, statistic2 === null || statistic2 === void 0 ? void 0 : statistic2.className, className, rootClassName, hashId);
  return wrapSSR(React39.createElement("div", {
    className: cls,
    style: Object.assign(Object.assign({}, statistic2 === null || statistic2 === void 0 ? void 0 : statistic2.style), style2),
    onMouseEnter,
    onMouseLeave
  }, title && React39.createElement("div", {
    className: `${prefixCls}-title`
  }, title), React39.createElement(skeleton_default, {
    paragraph: false,
    loading,
    ...
    style: valueStyle,
    className: `${prefixCls}-content`
  }, prefix2 && React39.createElement("span", {
    className: `${prefixCls}-content-prefix`
  }, prefix2), valueRender ? valueRender(valueNode) : valueNode, suffix && React39.createElement("span", {
...
//# sourceMappingURL=chunk-2THTGTMU.js.map
